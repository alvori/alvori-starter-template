...
exports.pkgJSON = ['name', 'productName', 'description', 'author', 'license']
...
exports.complete = async ({ name, projectDir, answers, chalk, installed }) => {
    const message = `
    ${chalk.green('Alvori Project initialization finished!')}
